import quality1Sofa from '../../../public/bed-images/quality1-sofa.png';
...
const Quality1 = () => {
  ...
  return (
    ...
    ">
      <div className="rounded-xl flex items-center justify-around hover:shadow-red-3xl transition-all duration-300 bg-gradient-to-b from-slate-600 via-slate-500 to-slate-600 py-16 
      miniDesktop:py-2
      bigTablet:py-1
      tablet:py-1
      miniTablet:py-1
      ...
      ">
        ...
        ">
          ...
          " src={quality1Sofa} alt={t('Sofa image')} />
        </div>
