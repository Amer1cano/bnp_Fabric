...
import quality2Sofa from '../../../public/bed-images/quality2-sofa.png';
...
const Quality2 = () => {
  ...
  return (
    ...
    ">
      <div className="rounded-xl flex items-center justify-around hover:shadow-red-3xl transition-all duration-300 bg-gradient-to-b from-[rgb(98,86,133)] via-[rgb(118,106,156)] to-[rgb(98,86,133)] py-16
      miniDesktop:py-6
      bigTablet:py-4
      tablet:py-1
      miniTablet:py-1
      ...
      ">
        ...
        '>
          ...
          ' src={quality2Sofa} alt={t('Sofa image')} />
        </div>
